...
export const CardSeeServiceModal = ({ open, onClose, service, onEditClick, onDeleteSuccess }: CardSeeServiceModalProps) => {
  ...
  useEffect(() => {
    ...
    const obtenerNombreTipoCliente = async () => {
      ...
      try {
        ...
        const tipoEncontrado = tipoClientes.find((tc: any) => String(tc._id) === tipoClienteId);
      ...
      onConfirm: async () => {
        ...
        try {
          ...
          window.dispatchEvent(new CustomEvent('app-notification', { 
            detail: { message: `Servicio ${accionTexto}do exitosamente`, severity: 'success' } 
          }));
          onClose();
