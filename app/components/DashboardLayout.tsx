...
export default function DashboardLayout({
  ...
  const [themeMode, setThemeMode] = React.useState<"corporate" | "dark">(
    "corporate",
  );
  ...
  React.useEffect(() => {
    ...
    const savedTheme = localStorage.getItem("netuno-theme") as
      | "corporate"
      | "dark";
    if (savedTheme) {
              ...
              >
                <ListItemButton
                  ...
                  sx={{
                    ...
                    "&:hover": {
                      bgcolor: !isDark ? "#fff" : "rgba(255,255,255,0.05)",
                    },
                  }}
                >
                ...
                <ListItemButton
                  ...
                  sx={{
                    ...
                    "&:hover": {
                      bgcolor: isDark ? "#090979" : "rgba(0,0,0,0.05)",
                    },
                  }}
                >
                  <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
